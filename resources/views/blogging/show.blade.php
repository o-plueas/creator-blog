...
<section class="relative bg-gray-100 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-16 lg:py-32 mt-5 ">
<div class="flex flex-col lg:flex-row lg:-mx-8 mt-5">

<div class="w-full md:max-w-md md:mx-auto lg:w-1/2 lg:px-8 mt-12 mt:md-0">
          <div class="bg-gray-400 w-full h-72 rounded-lg">
          <img src="{{$blog->logo ? asset('storage/' . $blog->logo) : asset('/images/spotify app.jpg') }}" class="rounded-lg w-full h-72" alt="">
        ...
        <div class="w-full lg:w-1/2 lg:px-8 mt-5">
          <h2 class="text-3xl leading-tight font-bold mt-5">{{$blog['title']}}</h2>
          <p class="mt-2 leading-relaxed">{{$blog['description']}}</p>
      ...
      <div class="flex justify-between w-full space-x-6 mt-4 p-2 bg-button-gradient border-2  rounded-lg">
